...
* __unique_collection_event_incomplete_merge__ Merged Unique collection events incomplete, It is NA if merge_unique_collection_event_incomplete is FALSE.
...
NROW(results$duplicates)
  ...
  write.csv(occ_results$parseGBIF_general_summary,
            file.summary, 
            row.names = FALSE, 
            fileEncoding = "UTF-8", 
            na = "")
  ...
  write.csv(occ_results$parseGBIF_merge_fields_summary,
            file.summary, 
            row.names = FALSE, 
            fileEncoding = "UTF-8", 
            na = "")
  ...
  write.csv(occ_results$parseGBIF_merge_fields_summary_complete,
            file.summary, 
            row.names = FALSE, 
            fileEncoding = "UTF-8", 
            na = "")
