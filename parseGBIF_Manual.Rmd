...
index <- results$occ_in_merge$Ctrl_key_family_recordedBy_recordNumber %in% 'ACHATOCARPACEAE_ZARDINI_5592'

print('campos')
print(jsonlite::fromJSON(results$occ_in_merge$parseGBIF_duplicates_map[index==TRUE]))
