...
A new R package to parse plant species occurrence records into unique collection events efficiently reduces data redundancy [DOI:10.1038/s41598-024-56158-3](https://doi.org/10.1038/s41598-024-56158-3)
...
## **Consult the [parseGBIF Manual](https://github.com/pablopains/parseGBIF/blob/main/parseGBIF_Manual_v2.pdf), __updated__, for a case study with a complete and replicable workflow**
