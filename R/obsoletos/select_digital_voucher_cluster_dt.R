...
#' @export
select_digital_voucher_cluster_dt <- function(occ = NA,
                                           occ_gbif_issue = NA,
                                           ...
                                           n_minimo = 10000)
{
  ...
  {
    digital_voucher <- select_digital_voucher_dt(occ = occ,
  ...
  }else
  {
    ...
    digital_voucher1 <- select_digital_voucher_dt(occ = occ[i_k_1==TRUE,],
    ...
    digital_voucher2 <- select_digital_voucher_dt(occ = occ[i_k_2==TRUE,],
    ...
    digital_voucher3 <- select_digital_voucher_dt(occ = occ[i_k_3==TRUE,],
    ...
    digital_voucher4 <- select_digital_voucher_dt(occ = occ[i_k_4==TRUE,],
    ...
    digital_voucher5 <- select_digital_voucher_dt(occ = occ[i_k_5==TRUE,],
    ...
    digital_voucher6 <- select_digital_voucher_dt(occ = occ[i_k_6==TRUE,],
    ...
    digital_voucher7 <- select_digital_voucher_dt(occ = occ[i_k_7==TRUE,],
    ...
    digital_voucher8 <- select_digital_voucher_dt(occ = occ[i_k_8==TRUE,],
    ...
    digital_voucher9 <- select_digital_voucher_dt(occ = occ[i_k_9==TRUE,],
    ...
    digital_voucher10 <- select_digital_voucher_dt(occ = occ[i_k_10==TRUE,],
    ...
    digital_voucher11 <- select_digital_voucher_dt(occ = occ[i_k_11==TRUE,],
    ...
    digital_voucher12 <- select_digital_voucher_dt(occ = occ[i_k_12==TRUE,],
    ...
    digital_voucher13 <- select_digital_voucher_dt(occ = occ[i_k_13==TRUE,],
    ...
    digital_voucher14 <- select_digital_voucher_dt(occ = occ[i_k_14==TRUE,],
    ...
    digital_voucher15 <- select_digital_voucher_dt(occ = occ[i_k_15==TRUE,],
    ...
    digital_voucher16 <- select_digital_voucher_dt(occ = occ[i_k_16==TRUE,],
    ...
    digital_voucher17 <- select_digital_voucher_dt(occ = occ[i_k_17==TRUE,],
    ...
    digital_voucher18 <- select_digital_voucher_dt(occ = occ[i_k_18==TRUE,],
    ...
    digital_voucher19 <- select_digital_voucher_dt(occ = occ[i_k_19==TRUE,],
    ...
    digital_voucher20 <- select_digital_voucher_dt(occ = occ[i_k_20==TRUE,],
    ...
    digital_voucher21 <- select_digital_voucher_dt(occ = occ[i_k_21==TRUE,],
    ...
    digital_voucher22 <- select_digital_voucher_dt(occ = occ[i_k_22==TRUE,],
    ...
    digital_voucher23 <- select_digital_voucher_dt(occ = occ[i_k_23==TRUE,],
    ...
    digital_voucher24 <- select_digital_voucher_dt(occ = occ[i_k_24==TRUE,],
